...
export default function NotificationsPage() {
  ...
  function getRequest(notification) {
    if (
    ...
    return requestsQuery.data?.find(
      (request) => request.id === notification.friendRequestId,
    );
  }
    ...
    >
      ...
      <Stack spacing={1.7}>
        {notificationsQuery.data?.items?.map((notification) => {
          const request = getRequest(notification);

          const avatar = notification.actorProfileImageUrl
            ? notification.actorProfileImageUrl.startsWith("http")
              ? notification.actorProfileImageUrl
              : `${API_ORIGIN}${notification.actorProfileImageUrl}`
            : null;

          const focused = focusedRequestId === notification.friendRequestId;
          ...
          return (
            <Paper
              ...
              sx={{
                ...
                borderColor: focused ? "primary.main" : "rgba(148,163,184,.16)",
            ...
            >
              ...
              >
                ...
                >
                  ...
                  {notification.type === "FriendRequest" && !request && (
                    <Chip
